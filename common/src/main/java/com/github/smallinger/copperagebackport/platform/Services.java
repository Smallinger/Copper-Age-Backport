...
public class Services {
    ...
    // Platform-specific helper for creating BlockEntityTypes (needed because BlockEntitySupplier is package-private)
    public static final IBlockEntityHelper BLOCK_ENTITY = load(IBlockEntityHelper.class);
    
    // Platform-specific helper for creating items (spawn eggs differ between loaders)
